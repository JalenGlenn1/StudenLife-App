...
class SubtractionTest : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subtraction_quiz)
        ...
        questionTextView.text = "$firstVariable - $secondVariable"

        var checkIfNegativeVariable = firstVariable - secondVariable

        //First checks to see if the resulting is a negative and if so it switches
        //the variables so that the resulting answer is not a negative.
        if (checkIfNegativeVariable < 0) {
        ...
        continueButton.setOnClickListener {
            ...
            if(timerRanOutBoolean){
                ...
                if (answerVariable == answerEditText.text.toString().toInt()){
                ...
                val c = Question(
                    ...
                    correct_answer = answerVariable.toString(),
                    quiz_id = quizID
                )
                ...
                //Else statement runs if the user has not yet answered 10 questions.
                    ...
                    if(questions.size < 11){
                        ...
                        checkIfNegativeVariable = firstVariable - secondVariable

                        //Checks to see if the resulting is a negative and if so it switches
                        //the variables so that the resulting answer is not a negative.
                        if (checkIfNegativeVariable < 0) {
